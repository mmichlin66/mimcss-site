...
We would like the name of the class to appear where we put the three question marks, but we don't know the name because it is generated by Mimcss. One of the solutions is the following:
